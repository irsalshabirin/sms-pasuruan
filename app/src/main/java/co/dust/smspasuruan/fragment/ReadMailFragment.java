...
public class ReadMailFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = ReadMailFragment.class.getSimpleName();
