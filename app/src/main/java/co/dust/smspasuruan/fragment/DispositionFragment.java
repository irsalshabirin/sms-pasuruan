...
public class DispositionFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = DispositionFragment.class.getSimpleName();
    ...
    public static Fragment newInstance() {
        return new DispositionFragment();
    }
...
//        }
        ...
        apiService
                .loadMail(
                        page,
                        perPage,
                        CommonConstants.DISPOSITION_MAIL,
