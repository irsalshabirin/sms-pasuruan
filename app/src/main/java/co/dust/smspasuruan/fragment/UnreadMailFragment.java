...
public class UnreadMailFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = UnreadMailFragment.class.getSimpleName();
